<div class="max-w-xl mx-auto space-y-6" x-data="{ showCurrent: false, showNew: false, showConfirm: false }">
    ...
    <x-ui.card class="p-6">
        <form wire:submit="changePassword" class="space-y-4">
            <!-- Current Password -->
            <div>
                <label class="block text-xs font-semibold text-[var(--color-text)] mb-1">Password Saat Ini</label>
                <div class="relative w-full">
                    ...
                    <button type="button" @click="showCurrent = !showCurrent" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-[var(--color-text)] focus:outline-none">
            ...
            <!-- New Password -->
            <div>
                <label class="block text-xs font-semibold text-[var(--color-text)] mb-1">Password Baru</label>
                <div class="relative w-full">
                    ...
                    <button type="button" @click="showNew = !showNew" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-[var(--color-text)] focus:outline-none">
                ...
                <p class="text-[11px] text-[var(--color-text-muted)] mt-1">Gunakan kombinasi minimal 8 karakter agar akun lebih aman.</p>
                @error('password') <span class="text-xs text-rose-500 mt-1 block font-medium">{{ $message }}</span> @enderror
            </div>

            <!-- Confirm Password -->
            <div>
                <label class="block text-xs font-semibold text-[var(--color-text)] mb-1">Konfirmasi Password Baru</label>
                <div class="relative w-full">
                    ...
                    <button type="button" @click="showConfirm = !showConfirm" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-[var(--color-text)] focus:outline-none">
