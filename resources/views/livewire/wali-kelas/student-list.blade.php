<div class="space-y-6">
    ...
    @else
        ...
        <!-- Search Bar -->
        <x-ui.card class="p-4 flex items-center justify-between gap-4">
            <div class="relative flex-1 max-w-md">
                ...
                <svg class="w-4 h-4 absolute left-3 top-3 text-[var(--color-text-muted)]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
            </div>
            <span class="text-xs text-[var(--color-text-muted)] font-medium">Total: {{ $students->total() }} Murid</span>
        </x-ui.card>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-xs">
                    ...
                    <tbody class="divide-y divide-[var(--color-border)] text-[var(--color-text)]">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-8 text-center text-[var(--color-text-muted)]">Belum ada data murid di kelas ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
