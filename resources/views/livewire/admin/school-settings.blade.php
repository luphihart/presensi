<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-xl font-bold text-[var(--color-text)]">Pengaturan Profil Sekolah</h2>
            <p class="text-xs text-[var(--color-text-muted)]">Atur identitas resmi sekolah yang akan tampil di aplikasi murid dan laporan</p>
        </div>
    </div>
    ...
    <x-ui.card>
        <form wire:submit="saveSettings" class="space-y-5">
            <div>
                ...
                <input type="text" wire:model="schoolName" class="w-full px-4 py-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] text-[var(--color-text)] focus:ring-2 focus:ring-[var(--color-primary)] focus:outline-none" placeholder="Contoh: SMA Negeri 1 Jakarta">
            ...
            <div>
                ...
                <textarea wire:model="schoolAddress" rows="3" class="w-full px-4 py-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] text-[var(--color-text)] focus:ring-2 focus:ring-[var(--color-primary)] focus:outline-none" placeholder="Contoh: Jl. Pemuda No. 10, Jakarta Pusat"></textarea>
            ...
            <div>
                ...
                <input type="text" wire:model="schoolPhone" class="w-full px-4 py-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] text-[var(--color-text)] focus:ring-2 focus:ring-[var(--color-primary)] focus:outline-none" placeholder="021-12345678">
