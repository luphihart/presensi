<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button wire:click="exportExcel" type="button" class="px-4 py-2.5 rounded-xl bg-[var(--color-primary)] text-white font-semibold text-sm shadow-md flex items-center justify-center space-x-2">
