...
<body class="min-h-screen pb-20 lg:pb-0 lg:flex">
    ...
    <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-[var(--color-surface)] border-t border-[var(--color-border)] px-4 py-2 flex justify-around items-center z-40">
