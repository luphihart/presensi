...
<body class="min-h-screen pb-20 lg:pb-0 lg:flex">
    ...
    <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-[var(--color-surface)] border-t border-[var(--color-border)] px-2 py-2 flex justify-around items-center z-40">
        ...
        <a href="{{ route('student.announcements') }}" class="flex flex-col items-center text-xs {{ request()->routeIs('student.announcements') ? 'text-[var(--color-primary)] font-semibold' : 'text-[var(--color-text-muted)]' }}">
            <svg class="w-6 h-6 mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.684A1.761 1.761 0 013 12c0-.663.364-1.24.908-1.543l3.526-1.958"/></svg>
            <span>Pengumuman</span>
        </a>
